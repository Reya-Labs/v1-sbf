...
class FillEvent(Event):
    ...
    def __init__(self, token, slippage, fee, timestamp, notional, direction):
        """
        ...
        direction - 'LONG' or 'SHORT'.
        notional - Non-negative integer for notional amount (margin*leverage) traded
        slippage - the delta between the fixed rate before the IRS trade was executed and the realised fixed rate
