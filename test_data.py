...
class TestDataHandler(unittest.TestCase):
    ...
    def test_open_and_convert_csv_files(self):
        ...
        self.assertEqual(str(next(self.dataHandler.token_data['aave_usdc'])[0]), '2021-03-16 11:49:16')
    ...
    def test_update_rates(self):
        ...
        self.assertEqual(str(self.dataHandler.latest_token_data['aave_usdc'][0][1]), '2021-03-11 14:49:24')
